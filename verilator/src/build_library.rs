...
fn build_dpi_if_needed(
    ...
    //let dpi_object_file = Utf8PathBuf::from("../dpi/dpi.o"); //
    // dpi_file.with_extension("o"); let dpi_c_wrappers =
    // Utf8PathBuf::from("../dpi/wrappers.cpp"); //
    // dpi_artifact_directory.join("wrappers.cpp");
    //
